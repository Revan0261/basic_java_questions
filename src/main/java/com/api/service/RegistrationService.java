...
public class RegistrationService {
    ...
    Registration mapToEntity(RegistrationDto registrationDto){
        Registration registration= modelMapper.map(registrationDto, Registration.class);//reducing the code line
...
RegistrationDto mapToDto( Registration registration){
    ...
    RegistrationDto dto = modelMapper.map(registration, RegistrationDto.class);//reducing the code line
...
//    dto.setMobile(registration.getMobile());
    ...
    public RegistrationDto getRegistrationById(long id) {
        Registration registration = registrationRepository.findById(id).orElseThrow(()->new ResourceNotFoundException("Record Not Found"));   ///in this supplier inteface used with lamda expression
